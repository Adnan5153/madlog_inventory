<section id="workflow" class="section bg-light">
    <div class="container">
        <div class="text-center mx-auto" style="max-width: 720px;">
            <p class="eyebrow mb-2">HOW IT FITS YOUR DAY</p>
            <h2 class="display-5 fw-bold mb-3 text-balance">From Receiving to Reorder</h2>
            <p class="lead text-secondary">Five steps that match the rhythm of a working storeroom — without paper ledgers or clipboards.</p>
        </div>

        <ol class="list-unstyled row g-4 mt-2" role="list">
